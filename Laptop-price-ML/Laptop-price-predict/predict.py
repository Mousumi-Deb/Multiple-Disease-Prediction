...
# Load the model
with open('C:/Users/E7440/Projects_22/Streamlit-App-Diseases-prediction/Laptop-price-ML/Laptop-price-predict/pipe.pkl', 'rb') as model_file:
    df_pipe = pickle.load(model_file)

with open('C:/Users/E7440/Projects_22/Streamlit-App-Diseases-prediction/Laptop-price-ML/Laptop-price-predict/df.pkl', 'rb') as data_file:
